...
public class SpacesApiImpl implements SpacesApi {
        ...
        if (secureNodeService.hasAspect(spaceNodeRef, CircabcModel.ASPECT_LIBRARY)
            ...
            if (!sort.equalsIgnoreCase("")) {
                Pair<QName, Boolean> sortPair =
                        new Pair<>(
                                QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, sort.split("_")[0]),
                                (sort.endsWith("ASC")));
    ...
    private void notifyLeaders(
        ...
        if (libAdminGroup != null) {
            ...
            final Map<String, Object> extraModelParams = buildModelParam(share, shareSpace);
    ...
    private Map<String, Object> buildModelParam(Share share, NodeRef shareSpace) {
