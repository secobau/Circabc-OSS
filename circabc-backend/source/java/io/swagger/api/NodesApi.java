...
public interface NodesApi {
    ...
    /**
     * used to update the ownership of the node the currently alf authenticated user will take the
     * ownership
     */
    ...
    SimpleId nodesIdGroupGet(String id) throws InvalidArgumentException;
}
