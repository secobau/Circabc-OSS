...
public class TopicsApiImpl implements TopicsApi {
    ...
    private Node getPost(final NodeRef childRef) {
        ...
        final NodeRef personNodeRef = personService.getPerson(postNode.getProperties().get(CREATOR));
    ...
    public void updateTopic(String id, Node topicNode) {
        ...
        if (securityRanking != null && !securityRanking.isEmpty()) {
            ...
            if (!"PUBLIC".equals(securityRanking)
                    && !"INTERNAL".equals(securityRanking)
                    && !"LIMITED".equals(securityRanking)) {
                throw new IllegalArgumentException(
                        "The 'security_ranking' has to be PUBLIC, INTERNAL or LIMITED");
            }
