...
public class NodesContentUploadPost extends CircabcDeclarativeWebScript {
    ...
    private final Long maxSizeUpload = (long) (1024 * 1024 * 300);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!this.currentUserPermissionCheckerService.verifyMemberPermission(
                    id, LibraryPermissions.LIBMANAGEOWN.toString())) {
