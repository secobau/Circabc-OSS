...
public interface LogDaoService {
    ...
    List<LogSearchResultDAO> getHistory(Long itemID);

    long countHistory(Long itemID);

    List<LogSearchResultDAO> getHistory(Long itemID, long startRecord, long pageSize);
