 ...
 * <p>Migration 3.1 -> 3.4.6 - 02/12/2011
 */
public class IBatisLogDaoServiceImpl implements LogDaoService {
     ...
     *
     * @see
     * eu.cec.digit.circabc.repo.log.ibatis.LogDaoService#insertPost(eu.cec.digit.circabc.service.log.
     * LogRecord)
     */
    ...
    public Integer getActivityID(String service, String activity) {
        ...
        Integer id =
                (Integer) sqlSessionTemplate.selectOne("CircabcLog.select_activity_id", logActivityDAO);
        return (id != null ? id : -1);
    }
    ...
    public List<String> getVisitedRestLogs(Integer id, String username) {
        return (List<String>)
                sqlSessionTemplate.selectList(
                        "CircabcLog.select_rest_log_by_id_user", new VisitedLogRestParametersDAO(username, id));
    }
    ...
    public Integer getTemplateID(String method, String template) {
        ...
        Integer id =
                (Integer) sqlSessionTemplate.selectOne("CircabcLog.select_template_id", logTemplateDAO);
        return (id != null ? id : -1);
    }
    ...
    public List<LogSearchResultDAO> search(
        ...
        return (List<LogSearchResultDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_log_records", params);
    }

    @SuppressWarnings("unchecked")
    public List<LogSearchResultDAO> searchPage(
            Long igID,
            String userName,
            String serviceDescription,
            String activityDescription,
        ...
        return (List<LogSearchResultDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_log_records_page", params);
    }
    ...
    public List<LogSearchResultDAO> getHistory(Long itemID) {
        ...
        return (List<LogSearchResultDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_item_history", itemID);
    }

    public long countHistory(Long itemID) {

        return (long) sqlSessionTemplate.selectOne("CircabcLog.count_item_history", itemID);
    }

    @SuppressWarnings("unchecked")
    public List<LogSearchResultDAO> getHistory(Long itemID, long startRecord, long pageSize) {

        LogSearchLimitParameterDAO params = new LogSearchLimitParameterDAO();
        params.setIgID(itemID);
        params.setStartRecord((int) startRecord);
        params.setPageSize((int) pageSize);

        return (List<LogSearchResultDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_item_history_pagination", params);
    }
    ...
    public Date getLastLoginDateOfUser(String username) {
        ...
        return (Date)
                sqlSessionTemplate.selectOne("CircabcLog.select_last_login_date_of_user", username);
    }

    @SuppressWarnings("unchecked")
    public List<LogCountResultDAO> getNumberOfActionsYesterdayPerHour() {
        return (List<LogCountResultDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_count_actions_per_hour_yesterday");
    }

    @SuppressWarnings("unchecked")
    public List<ActivityCountDAO> getListOfActivityCountForInterestGroup(Long igDbNode) {

        return (List<ActivityCountDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_activity_of_interest_group", igDbNode);
    }
    ...
    public List<UserActionLogDAO> getRecentUserDownloads(String userId, int i) {
        ...
        return (List<UserActionLogDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_download_logs_for_user", params);
    }
    ...
    public List<UserActionLogDAO> getRecentUserUploads(String userId, int i) {
        ...
        return (List<UserActionLogDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_upload_logs_for_user", params);
    }
    ...
    public List<Long> getUserDashboardActivityIds() {
        ...
        return (List<Long>)
                sqlSessionTemplate.selectList("CircabcLog.select_activity_id_for_news_feed");
    }
    ...
    public List<UserActionLogDAO> getUserDashboardActivities(UserNewsFeedRequest request) {
        return (List<UserActionLogDAO>)
                sqlSessionTemplate.selectList("CircabcLog.select_group_news_feed_uploads", request);
    }
        ...
        Long id =
                (Long)
                        sqlSessionTemplate.selectOne(
                                "CircabcLog.select_activity_id_by_template_id", templateID);
        return (id != null ? id : -1);
    }
