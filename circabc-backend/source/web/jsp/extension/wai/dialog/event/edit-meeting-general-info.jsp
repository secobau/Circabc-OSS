...
<circabc:panel id="meetingInfoDialogMainForm" styleClass="contentMainForm">
	...
	<h:panelGrid columns="3" cellpadding="3" cellspacing="3" border="0" >
		<h:graphicImage value="/images/icons/required_field.gif" alt="#{msg.required_field}" />
			...
			<h:selectOneMenu id="meeting-type" value="#{WaiDialogManager.bean.appointment.meetingType}" converter="eu.cec.digit.circabc.faces.EnumConverter">
				<f:selectItems value="#{WaiDialogManager.bean.meetingTypes}"/>
			</h:selectOneMenu>
