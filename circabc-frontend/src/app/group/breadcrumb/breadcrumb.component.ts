...
export class BreadcrumbComponent implements OnInit, OnChanges {
  ...
  @Input()
  public path!: Node[];
  // if displayName === true, the names of the breadcrumb are diplayed directly, if false, the title is tried
  @Input()
  ...
  public async ngOnChanges() {
    ...
    this.path = await this.nodesService.getPath(this.node).toPromise();
