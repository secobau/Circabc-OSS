...
import { SpaceService } from 'app/core/generated/circabc/api/space.service';
import { ShareSpaceItem } from 'app/core/generated/circabc/model/models';
...
export class AddDropdownComponent implements OnInit {
  ...
  public async loadShares(params: { [key: string]: string }) {
    ...
    if (this.spaceId) {
      this.sharedSpaceItems = await this.spaceService
        .getExportedSharedSpaces(this.spaceId)
        .toPromise();
    }
  }
