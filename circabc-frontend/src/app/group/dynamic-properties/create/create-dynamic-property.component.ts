...
import { DynamicPropertyDefinitionUpdatedValues } from 'app/core/generated/circabc/model/dynamicPropertyDefinitionUpdatedValues';
...
export class CreateDynamicPropertyComponent implements OnChanges, OnInit {
  ...
  public async create() {
    ...
    const res = await this.dynamicPropertiesService
      .postPropertyDefinition(this.groupId, newProp)
      .toPromise();
    if (res) {
  ...
  public async update() {
    ...
    try {
      if (this.property && this.property.id) {
        ...
        await this.dynamicPropertiesService
          .putDynamicPropertyDefinition(this.property.id, this.property)
          .toPromise();
  ...
  public async loadDynamicProperty(id: string) {
    this.loading = true;
    this.originalProperty = await this.dynamicPropertiesService
      .getDynamicPropertyDefinition(id)
      .toPromise();
