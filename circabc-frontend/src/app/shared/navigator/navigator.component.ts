...
export class NavigatorComponent implements OnInit, OnDestroy {
  ...
  private listenGroupRefresh() {
    this.interestGroupReloadsubscription$ = this.groupReloadListenerService.refreshAnnounced$.subscribe(
  ...
  private setPermissions() {
    ...
    /*if (perms.library.indexOf('NoAccess') === -1) {
      this.canSeeLibrary = true;
    }*/
