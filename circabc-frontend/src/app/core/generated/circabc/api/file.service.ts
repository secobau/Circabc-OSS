...
export class FileService {
   ...
   */
  public fireNewContentNotification(
    id: string,
  ...
  public fireNewContentNotification(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling fireNewContentNotification.'
      );
    }
  ...
  public uploadFile(
    ...
    if (isPivot !== undefined) {
      formParams =
        (formParams.append('isPivot', <any>isPivot) as any) || formParams;
    }
    if (lang !== undefined) {
    ...
    if (fileName !== undefined) {
      formParams =
        (formParams.append('fileName', <any>fileName) as any) || formParams;
    }
    ...
    return this.httpClient.post<FileUploadResult>(
      `${this.configuration.basePath}/nodes/${encodeURIComponent(
        String(id)
      )}/upload`,
