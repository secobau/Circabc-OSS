...
export class DashboardService {
   ...
   */
  public getGroupDashboard(
    id: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<GroupDashboard>;
  public getGroupDashboard(
    id: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<GroupDashboard>>;
  public getGroupDashboard(
    id: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<GroupDashboard>>;
  public getGroupDashboard(
    id: string,
    observe: any = 'body',
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getGroupDashboard.'
      );
    }
    ...
    return this.httpClient.get<GroupDashboard>(
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getUserDownloads(
    userId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<Array<UserActionLog>>;
  public getUserDownloads(
    userId: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<Array<UserActionLog>>>;
  public getUserDownloads(
    userId: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<Array<UserActionLog>>>;
  public getUserDownloads(
    userId: string,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getUserDownloads.'
      );
    }
    ...
    return this.httpClient.get<Array<UserActionLog>>(
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getUserNewsFeed(
    userId: string,
    when?: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<UserNewsFeed>;
  public getUserNewsFeed(
    userId: string,
    when?: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<UserNewsFeed>>;
  public getUserNewsFeed(
    userId: string,
    when?: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<UserNewsFeed>>;
  public getUserNewsFeed(
    userId: string,
    when?: string,
    observe: any = 'body',
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getUserNewsFeed.'
      );
    }
    ...
    return this.httpClient.get<UserNewsFeed>(
      `${this.configuration.basePath}/users/${encodeURIComponent(
        String(userId)
      )}/dashboard/newsfeed`,
      {
  ...
  public getUserUploads(
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getUserUploads.'
      );
    }
